...
#         self.qnetwork_local = QNetwork(state_size, action_size, seed, 32, 32, 32).to(device)
#         self.qnetwork_target = QNetwork(state_size, action_size, seed, 32, 32, 32).to(device)
